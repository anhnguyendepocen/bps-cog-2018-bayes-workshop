...
\author[Andrews]{Mark Andrews \\ $\phantom{foo}$ \\ Psychology, Nottingham Trent University \\ $\phantom{foo}$ \\ \faEnvelopeO \  \texttt{mark.andrews@ntu.ac.uk} \\ \faTwitter \href{https://twitter.com/xmjandrews}{@xmjandrews} \\ $\phantom{foo}$ \\ \faGithub \ \url{https://github.com/lawsofthought/bps-cog-2018-bayes-workshop}}
